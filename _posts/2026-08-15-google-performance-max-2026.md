...
published: true
faq:
  - question: "Performance Max có thay Search campaign không?"
    answer: "Không hoàn toàn. Google mô tả PMax bổ sung cho Search và ưu tiên Search khi truy vấn khớp chính xác với keyword đủ điều kiện. Cấu trúc phù hợp tùy mục tiêu, query control và dữ liệu."
  - question: "Audience signal có giới hạn quảng cáo chỉ chạy đúng tệp không?"
    answer: "Không. Audience signal là điểm khởi đầu/gợi ý cho hệ thống tìm người có khả năng chuyển đổi; nó không phải hard targeting như nhiều người tưởng."
  - question: "Nên tách asset group theo kích thước ảnh không?"
    answer: "Không. Nên tách theo chủ đề sản phẩm, margin, landing page hoặc thông điệp khác biệt; mỗi nhóm vẫn cần đủ loại asset theo hướng dẫn Google."
  - question: "Có dùng negative keywords cho PMax được không?"
    answer: "Google Ads có hỗ trợ negative keywords ở cấp chiến dịch/tài khoản trong phạm vi và loại khớp được tài liệu quy định. Cần dùng để loại ý định không phù hợp, không bóp mất nhu cầu tốt."
---
