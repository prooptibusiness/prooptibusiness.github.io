...
published: true
faq:
  - question: "Responsible và Accountable khác nhau thế nào?"
    answer: "Responsible trực tiếp làm hoặc điều phối công việc; Accountable sở hữu kết quả và quyền duyệt cuối. Một người có thể giữ cả hai ở team nhỏ nhưng vai trò vẫn nên được ghi rõ."
  - question: "Mỗi việc có được nhiều Accountable không?"
    answer: "Nên tránh. Một Accountable giúp xác định quyết định cuối; nhiều người đồng duyệt thường tạo vòng lặp và trách nhiệm mơ hồ."
  - question: "RACI có dùng cho mọi task nhỏ không?"
    answer: "Không. Dùng cho deliverable, handoff và quyết định có rủi ro/độ mơ hồ. Task cá nhân đơn giản chỉ cần owner và deadline."
  - question: "RACI khác DACI ở đâu?"
    answer: "RACI nhấn mạnh thực thi và trách nhiệm; DACI của Atlassian tập trung quyết định với Driver, Approver, Contributors, Informed. Có thể dùng DACI cho quyết định lớn và RACI cho workflow."
---

## RACI trong Marketing là gì?
