---
layout: post
title: "AOV là gì? Cách tăng giá trị đơn hàng mà không phá Conversion"
slug: aov-la-gi
description: "AOV là gì? Cách tính Average Order Value và tăng giá trị đơn bằng Bundle, Cross-sell, Threshold, Merchandising nhưng vẫn giữ Conversion và Margin."
answer_summary: "AOV, hay Average Order Value, là giá trị đơn hàng trung bình trong một kỳ, thường tính bằng doanh thu hoặc giá trị đơn chia cho số đơn theo định nghĩa nhất quán. Tăng AOV có thể cải thiện Economics nếu Margin tốt, nhưng không nên ép khách mua nhiều đến mức Conversion giảm, Return tăng hoặc trải nghiệm xấu đi."
...
tags: ["AOV","Average Order Value","E-commerce Metrics","Upsell"]
image: /assets/blog/aov-la-gi-2026.svg
image_alt: "Minh họa 2D AOV là gì theo phong cách biểu đồ và sơ đồ PoB"
...
published: true
faq:
  - question: "AOV càng cao càng tốt?"
    answer: "Không. Cần xem Conversion, Margin, Return và Customer Satisfaction."
  - question: "Cách tính AOV là gì?"
    answer: "Thông thường lấy Revenue hoặc Order Value chia số Orders theo cùng phạm vi và định nghĩa."
  - question: "Free Shipping Threshold có tăng AOV không?"
    answer: "Có thể, nhưng cần test vì Threshold quá cao có thể giảm Conversion."
  - question: "AOV khác LTV thế nào?"
    answer: "AOV là giá trị trung bình mỗi đơn; LTV là giá trị kỳ vọng qua toàn bộ quan hệ khách hàng."
---

## AOV là gì?

**AOV là gì** nên được hiểu như một mô hình làm việc có thể đo và cải tiến, không phải một nhãn thời thượng. Với PoB, giá trị của chủ đề này nằm ở chỗ nó giúp đội ngũ liên kết hành vi khách hàng, dữ liệu và quyết định vận hành thay vì chỉ nhìn một chỉ số riêng lẻ.
...
Một mô hình chỉ có giá trị khi nó giúp thay đổi quyết định. Với **AOV là gì**, đội ngũ nên hỏi ba lớp câu hỏi: vấn đề nào đang xảy ra, tín hiệu nào chứng minh vấn đề đó, và thay đổi nào có khả năng tạo tác động đủ lớn. Cách tiếp cận này tránh việc chọn giải pháp trước rồi mới đi tìm lý do.
...
Gộp sản phẩm bổ sung với Logic Value rõ. Đây là một phần cần được định nghĩa bằng hành vi hoặc dữ liệu cụ thể để cả team hiểu giống nhau.

### Cross-sell

Gợi ý sản phẩm liên quan tại PDP, Cart hoặc Post-purchase. Đây là một phần cần được định nghĩa bằng hành vi hoặc dữ liệu cụ thể để cả team hiểu giống nhau.

### Upsell

Nâng lên phiên bản hoặc Pack giá trị cao hơn. Đây là một phần cần được định nghĩa bằng hành vi hoặc dữ liệu cụ thể để cả team hiểu giống nhau.

### Free-shipping Threshold

Ngưỡng khuyến khích tăng Basket nếu Economics phù hợp. Đây là một phần cần được định nghĩa bằng hành vi hoặc dữ liệu cụ thể để cả team hiểu giống nhau.

### Merchandising

Sắp xếp Assortment và Recommendation theo Intent. Đây là một phần cần được định nghĩa bằng hành vi hoặc dữ liệu cụ thể để cả team hiểu giống nhau.
...
1. **Tính AOV Baseline theo Channel và Segment.**
2. **Xác định Margin của từng SKU trước khi Bundle.**
3. **Test Threshold và Cross-sell theo Cohort hoặc Experiment.**
4. **Theo dõi Conversion, Margin và Return cùng AOV.**
5. **Tách New và Returning Customer vì Basket Behavior có thể khác.**
...
| Chỉ số | Cách đọc |
|---|---|
| AOV | Doanh thu hoặc Order Value trên số đơn. |
| Items per Order | Số Item trung bình. |
| Attach Rate | Tỷ lệ Order có Add-on/Cross-sell. |
| Conversion Rate | Guardrail để tránh tăng AOV nhưng giảm Order. |
| Contribution per Order | Giá trị kinh tế trên đơn. |
...
- **Tăng AOV bằng Discount làm Margin giảm mạnh.**
- **Đẩy Add-on không liên quan.**
- **Dùng Pop-up Upsell quá sớm gây Friction.**
- **Không Segment Mobile/Desktop hoặc New/Returning.**
- **Đọc AOV tăng do Price Inflation như tăng trưởng hành vi.**
...
- **Đọc tiếp:** [Conversion Rate E-commerce](/blog/conversion-rate-ecommerce-la-gi/) — Nối chủ đề này với hệ thống kiến thức PoB.
- **Đọc tiếp:** [GMV](/blog/gmv-la-gi/) — Nối chủ đề này với hệ thống kiến thức PoB.
...
- **Nguồn:** [Shopify — Average Order Value](https://www.shopify.com/blog/average-order-value)
- **Nguồn:** [Google Analytics — Ecommerce Metrics](https://support.google.com/analytics/answer/9268036)
- **Nguồn:** [Stripe — Ecommerce Metrics](https://stripe.com/resources/more/ecommerce-metrics)
