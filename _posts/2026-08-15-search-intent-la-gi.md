...
answer_summary: "Search intent là mục đích người dùng muốn hoàn thành khi tìm kiếm, như hiểu một khái niệm, so sánh lựa chọn, thực hiện tác vụ hoặc đến một địa chỉ cụ thể. Phân tích intent tốt kết hợp ngôn ngữ truy vấn với loại kết quả Google hiển thị, bối cảnh khách hàng và giá trị kinh doanh; sau đó map một nhu cầu chính cho mỗi URL phù hợp."
target_query: "Search intent là gì và cách phân tích ý định tìm kiếm?"
date: 2026-08-15T00:21:00+07:00
date_modified: 2026-08-15T00:21:00+07:00
category: content-seo
category_label: "Content & SEO"
tags: ["Search Intent","Keyword Research","SEO Content","Cannibalization"]
image: /assets/blog/search-intent-la-gi.webp
image_alt: "Minh họa search intent là gì? cách lập bản đồ truy vấn đúng nhu cầu"
...
published: true
faq:
  - question: "Có mấy loại search intent?"
    answer: "Bốn nhãn phổ biến là informational, navigational, commercial investigation và transactional. Đây là khung gợi ý; nhiều truy vấn có intent pha trộn và SERP thay đổi theo ngữ cảnh."
  - question: "Một bài có thể phục vụ nhiều intent không?"
    answer: "Có thể phục vụ các intent gần nhau trong cùng job, nhưng không nên ép một trang vừa là hướng dẫn chuyên sâu, bảng giá, trang sản phẩm và đăng nhập nếu cấu trúc không phù hợp."
  - question: "Cannibalization là gì?"
    answer: "Keyword cannibalization xảy ra khi nhiều URL cùng nhắm một nhu cầu gần như giống nhau và cạnh tranh tín hiệu. Không phải mọi URL cùng từ khóa đều cannibalize nếu intent/đầu ra khác."
  - question: "Search volume thấp có nên viết không?"
    answer: "Có nếu truy vấn thể hiện nhu cầu giá trị cao, hỗ trợ sale hoặc là mắt xích trong topic cluster. Volume tool là ước tính và có thể gộp nhiều biến thể."
---
