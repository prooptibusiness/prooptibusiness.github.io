...
published: true
faq:
  - question: "Doanh thu có nên là North Star Metric không?"
    answer: "Doanh thu quan trọng nhưng thường là kết quả doanh nghiệp thu được, chưa mô tả giá trị khách hàng đã nhận. Có thể dùng doanh thu làm outcome và ghép với một chỉ số sử dụng/giá trị cốt lõi."
  - question: "Một công ty có thể có nhiều North Star Metric không?"
    answer: "Có thể có một NSM cấp công ty và các input metric theo sản phẩm hoặc thị trường. Nếu có quá nhiều North Star ngang hàng, ưu tiên sẽ bị phân tán."
  - question: "KPI có phải Key Result không?"
    answer: "Không hoàn toàn. KPI là chỉ số sức khỏe cần theo dõi liên tục; Key Result là kết quả định lượng cần thay đổi để đạt Objective trong một chu kỳ."
  - question: "Bao lâu nên cập nhật OKR?"
    answer: "Theo Atlassian, đội ngũ có thể chấm tiến độ hàng tháng và đặt chu kỳ theo quý. Nhịp cụ thể tùy tốc độ kinh doanh, nhưng không nên chờ cuối quý mới xem lại."
---

## North Star Metric, KPI và OKR là gì?
